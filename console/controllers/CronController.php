...
/**
 * 分钟级定时任务
 * * * * * * root /apppath/yii cron --interpreterPath=/usr/local/php7.4/bin/php  > /dev/null 2>&1
 */
...
Actions:
    ...
    help - Show this help.
    list - Show active tasks with table.
...
RAW;
    ...
    public function options($actionID)
    {
        ...
        return ['color', 'interactive', 'help', 'silentExitOnException', 'interpreterPath', 'tagPrefix', 'logsDir', 'logFileName', 'bootstrapScript', 'timestamp'];
    }
}
